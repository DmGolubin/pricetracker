...
async function retryFailedTrackers(pool) {
  ...
  var noopCollector = { addChange: function() {}, addUnchanged: function() {}, hasChanges: function() { return false; } };
  ...
  // Individual alerts already sent inline by checkSingleTracker
